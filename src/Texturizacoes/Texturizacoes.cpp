...
int main() {
    ...
    sprites[2].SetPosition(vec2(150, 500)); sprites[2].SetSize(vec2(200, 150));
    sprites[3].SetPosition(vec2(650, 450)); sprites[3].SetSize(vec2(200, 150));
    sprites[4].SetPosition(vec2(400, 100)); sprites[4].SetSize(vec2(800, 200));
    sprites[5].SetPosition(vec2(200, 200)); sprites[5].SetSize(vec2(100, 100));
    sprites[6].SetPosition(vec2(600, 200)); sprites[6].SetSize(vec2(100, 100));
