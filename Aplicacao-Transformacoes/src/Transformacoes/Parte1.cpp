...
int main()
{
	...
	VAOs.push_back(createTriangle(0.1, -0.5, 0.5, -0.5, 0.3, 0.1)); 
	VAOs.push_back(createTriangle(-0.8, -0.2, -0.4, -0.2, -0.6, 0.3));
	VAOs.push_back(createTriangle(0.4, 0.4, 0.8, 0.4, 0.6, 0.8));
	VAOs.push_back(createTriangle(-0.3, -0.7, 0.1, -0.7, -0.1, -0.3));  
	...
	glUniform4f(colorLoc,  1.0f, 0.41f, 0.71f, 1.0f); 
